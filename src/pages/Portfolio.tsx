...
function Portfolio() {
  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#eef4ff] to-[#f0f7ff] flex flex-col items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#eef4ff] via-[#f0f7ff] to-[#e8f0fe] pb-16 relative">
